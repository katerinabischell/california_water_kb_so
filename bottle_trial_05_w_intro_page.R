      ...
      tabItem(tabName = "intro",
              fluidRow(
                box(width = 12, title = "Introduction", status = "primary",
                    p("Welcome to the California Coastal Water Quality Explorer. This application allows users to explore hydrographic data from the California Cooperative Oceanic Fisheries Investigations (CalCOFI)."),
                    p("Users can interact with maps, visualize time-series trends, explore summary statistics, and apply advanced data analysis techniques.")
                )
              )
      ),
      tabItem(tabName = "map",
