                ...
                fluidRow(
                  box(width = 12, title = "Introduction", status = "primary",
                      ...
                      tags$ul(
                        ...
                        tags$li("Run advanced PCA and Multiple Linear Regression analyses in the 'Advanced Analysis' tab.")
                      ),
                ...
                fluidRow(
                  box(width = 12, title = "Advanced Analysis Options",
                      ...
                      tags$ul(
                        ...
                        tags$li(strong("Multiple Linear Regression:"), " Models the relationship between a response variable and multiple predictor variables. Use MLR to understand which factors most strongly influence a particular water quality parameter.")
                      ),
...
server <- function(input, output, session) {
  ...
  output$analysis_ui <- renderUI({
    if (input$analysis_type == "pca") {
      ...
      tagList(
        box(width = 12,
            p("Multiple Linear Regression (MLR) allows you to model the relationship between a response variable and multiple predictor variables."),
            p("Select one response variable and at least one predictor variable. Avoid including your response variable in your predictors."),
